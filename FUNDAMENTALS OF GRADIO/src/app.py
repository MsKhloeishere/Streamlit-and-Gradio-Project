...
pipeline=joblib.lone('pipe.pkl')


def grad(gender, SeniorCitizen, Partner, Dependents, Contract, tenure, MonthlyCharges,
    ...
    Predict=pipeline.predict(inputdata)
    if Predict[0]=='yes':
        return 'Churn'
    else:
        return 'Not Churn'
...
# Setting Gradio App Interface
    ...
    demo.launch(inbrowser = True)# Setting Gradio App Interface
